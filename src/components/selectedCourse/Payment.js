  ...
  return (
    <div>
        <div class="cardP work">
            ...
            <div class="cardP-desc">
            <div class="cardP-header">
            <div class="cardP-title"></div>
            <div class="cardP-menu">
            <div class="dot"></div>
            <div class="dot"></div>
                <div class="dot"></div>
                </div>
            </div>
            <div class="cardP-time">Membership</div>
            <p class="recent">Exclusive Discounts</p>
            </div>
        </div>
    </div>
  )
