...
import { reviewSentiments } from '../data/ReviewList1'
...
function UdacitySelected() {
    ...
    const handleMembership = () => {
        ...
        if (isLoggedIn === 'true') {
            ...
            alert("Please log in to access the membership page.");
            navigate('/login');
        }
    }
  ...
  return (
    <div id='parentDiv'>
        ...
        <div className='row'>
            <div className='col-6' onClick={handleBtnClick} id='reviewButton'>
                <RedirectButton />
            </div>
            <div onClick={handleMembership} style={{marginTop: '-410px', marginLeft: '27px'}} className='col-6'>
                <Payment />
            </div>
        </div>
